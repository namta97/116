...
-- Sum bang du lieu nhom A nam N
SELECT		Top(1) * 
FROM		#SUM_TbHCGroupA  sumhc_A
...
-- Sum bang du lieu nhom A nam N-1
SELECT		Top(1) * 
FROM		#SUM_TbHCGroupA  sumhc_A
cross apply ( select * from #SUM_TbHCOTGroupA ) sumhcot_A
cross apply ( select * from #SUM_TbOTGroupA ) sumot_A
...
-- Sum bang du lieu nhom B nam N
SELECT		Top(1) * 
FROM		#SUM_TbHCGroupB sumhc_B
...
-- Sum bang du lieu nhom B nam N-1
SELECT		Top(1) * 
FROM		#SUM_TbHCGroupB sumhc_B
cross apply ( select * from #SUM_TbHCOTGroupB ) sumhcot_B
cross apply ( select * from #SUM_TbOTGroupB ) sumot_B
