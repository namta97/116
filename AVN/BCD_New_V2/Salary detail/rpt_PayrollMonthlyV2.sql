...
,''AVN_I_KSK'',''AVN_I_SFSUPPORT'',''AVN_I_WEDA'',''AVN_I_BIRA'',''AVN_I_FURA'',''AVN_I_FURA_E'',''AVN_I_OTC'',''AVN_I_TCCC'',''AVN_I_TCKC'',''AVN_I_DCCT1'',''AVN_I_DCCT2'',''AVN_I_KSKDK'',''AVN_I_KSKDB'',''AVN_I_GIFT'',''AVN_I_THEDT'',''AVN_I_DPHUC''
,''AVN_I_GIFT_CD'',''AVN_I_DLCV'',''AVN_I_DLGD'',''AVN_I_NMAT'',''AVN_I_TCTT'',''AVN_I_INTAX'',''AVN_I_AN'',''AVN_I_TNRR'',''AVN_I_F0SUPPORT'',''AVN_I_OTHER'',''AVN_ThuNhapKhac_TrongThang'',''AVN_I_TETBONUS'',''AVN_I_SLR13'',''AVN_I_S_BONUS'',''AVN_I_TL_2_9''
,''AVN_I_TL_1_1'',''AVN_I_LT_REWARD_10_15_20_25_30'',''AVN_TongThuong_TrongThang'',''AVN_IA_LCB'',''AVN_IA_LNV'',''AVN_IA_LNC'',''AVN_IA_PCGD'',''AVN_IA_PCNO'',''AVN_IA_PCNO2'',''AVN_IA_PCNL'',''AVN_IA_SMAA'',''AVN_IA_PCCVU'',''AVN_IA_PCCV'',''AVN_IA_PCLCB''
,''AVN_IA_PCTH'',''AVN_IA_TCDL'',''AVN_IA_PCDV'',''AVN_IA_PCTNIEN_BL'',''AVN_IA_PCCVBL'',''AVN_IA_PCLT'',''AVN_IA_PC_TC'',''AVN_IA_OT1_Tax'',''AVN_IA_OT1_NonTax'',''AVN_IA_OT2_Tax'',''AVN_IA_OT2_NonTax'',''AVN_IA_OT2H'',''AVN_IA_OT'',''AVN_IA_NS1''
,''AVN_IA_NS2'',''AVN_IA_NS3'',''AVN_IA_NS4'',''AVN_IA_NS'',''AVN_IA_DCCT1'',''AVN_IA_DCCT2'',''AVN_IA_TCCC'',''AVN_IA_TCKC'',''AVN_IA_SLR13'',''AVN_IA_S_BONUS'',''AVN_IA_TETBONUS'',''AVN_IA_TL1_1'',''AVN_IA_TL2_9'',''AVN_IA_LT_REWARD_10_15_20_25_30''
...
,''AVN_DA_AUCT2'',''AVN_DA_AUCT2_OT'',''AVN_DA_AUWFH'',''AVN_DA_AUWFH_OT'',''AVN_DA_SFSUPPORT'',''AVN_DA_WEDA'',''AVN_DA_BIRA'',''AVN_DA_FURA'',''AVN_DA_FURA_E'',''AVN_DA_GXE'',''AVN_DA_LTRU'',''AVN_DA_TCCTP'',''AVN_DA_DLCT'',''AVN_DA_KSK'',''AVN_DA_KSKDK''
...
,''AVN_BHXH_C'',''AVN_BHYT_C'',''AVN_BHTN_C'',''AVN_BHXH_E'',''AVN_BHYT_E'',''AVN_BHTN_E'',''AVN_TT_BHYT_E'',''AVN_SoNguoiPhuThuoc'',''AVN_GiamTruPhuThuoc'',''AVN_GiamTruBanThan'',''AVN_TinhThue'',''AVN_ThuePIT'',''AVN_LCB_TCTV_AVG_6_MONTH''
,''AVN_LCB_TCTV_AVG_3_MONTH'',''AVN_LuongTinh_TCTV'',''AVN_SoNamHuongTCTV'',''AVN_TCTV_NonTaxable'',''AVN_TCTV_Taxable'',''AVN_TCTV_Tax'',''AVN_TongKhoanKhauTru'',''AVN_GrossIncome'',''AVN_AdvancePay'',''AVN_NetIncome'', ''AVN_I_GIFT_BY_CASH''
, ''AVN_I_TCTT_BY_CASH'',''AVN_ThuNhapNgoaiLuong'',''AVN_Deduction_SUM_Payslip'',''DA_FURA_E'',''I_FURA_E'')'
...
,[AVN_I_AUCT2_OT],[AVN_I_AUWFH],[AVN_I_AUWFH_OT],[AVN_I_GXE],[AVN_I_LTRU],[AVN_I_TCCTP],[AVN_I_DLCT],[AVN_I_KSK],[AVN_I_SFSUPPORT],[AVN_I_WEDA],[AVN_I_BIRA],[AVN_I_FURA],[AVN_I_FURA_E],[AVN_I_OTC],[AVN_I_TCCC],[AVN_I_TCKC],[AVN_I_DCCT1],[AVN_I_DCCT2]
,[AVN_I_KSKDK],[AVN_I_KSKDB],[AVN_I_GIFT],[AVN_I_THEDT],[AVN_I_DPHUC],[AVN_I_GIFT_CD],[AVN_I_DLCV],[AVN_I_DLGD],[AVN_I_NMAT],[AVN_I_TCTT],[AVN_I_INTAX],[AVN_I_AN],[AVN_I_TNRR],[AVN_I_F0SUPPORT],[AVN_I_OTHER],[AVN_ThuNhapKhac_TrongThang],[AVN_I_TETBONUS]
,[AVN_I_SLR13],[AVN_I_S_BONUS],[AVN_I_TL_2_9],[AVN_I_TL_1_1],[AVN_I_LT_REWARD_10_15_20_25_30],[AVN_TongThuong_TrongThang],[AVN_IA_LCB],[AVN_IA_LNV],[AVN_IA_LNC],[AVN_IA_PCGD],[AVN_IA_PCNO],[AVN_IA_PCNO2],[AVN_IA_PCNL],[AVN_IA_SMAA],[AVN_IA_PCCVU]
...
,[AVN_DA_AUVP1_OT],[AVN_DA_AUVP2],[AVN_DA_AUVP2_OT],[AVN_DA_AUCT1],[AVN_DA_AUCT1_OT],[AVN_DA_AUCT2],[AVN_DA_AUCT2_OT],[AVN_DA_AUWFH],[AVN_DA_AUWFH_OT],[AVN_DA_SFSUPPORT],[AVN_DA_WEDA],[AVN_DA_BIRA],[AVN_DA_FURA],[AVN_DA_FURA_E],[AVN_DA_GXE],[AVN_DA_LTRU]
,[AVN_DA_TCCTP],[AVN_DA_DLCT],[AVN_DA_KSK],[AVN_DA_KSKDK],[AVN_DA_KSKDB],[AVN_DA_GIFT],[AVN_DA_THEDT],[AVN_DA_DPHUC],[AVN_DA_GIFT_CD],[AVN_DA_DLCV],[AVN_DA_DLGD],[AVN_DA_NMAT],[AVN_DA_TCTT],[AVN_DA_INTAX],[AVN_DA_AN],[AVN_DA_TNRR],[AVN_DA_F0SUPPORT]
,[AVN_DA_Other],[AVN_TruyThu],[AVN_BHXH_C],[AVN_BHYT_C],[AVN_BHTN_C],[AVN_BHXH_E],[AVN_BHYT_E],[AVN_BHTN_E],[AVN_TT_BHYT_E],[AVN_SoNguoiPhuThuoc],[AVN_GiamTruPhuThuoc],[AVN_GiamTruBanThan],[AVN_TinhThue],[AVN_ThuePIT],[AVN_LCB_TCTV_AVG_6_MONTH]
,[AVN_LCB_TCTV_AVG_3_MONTH],[AVN_LuongTinh_TCTV],[AVN_SoNamHuongTCTV],[AVN_TCTV_NonTaxable],[AVN_TCTV_Taxable],[AVN_TCTV_Tax],[AVN_TongKhoanKhauTru],[AVN_GrossIncome],[AVN_AdvancePay],[AVN_NetIncome],[AVN_I_GIFT_BY_CASH],[AVN_I_TCTT_BY_CASH]
,[AVN_ThuNhapNgoaiLuong],[AVN_Deduction_SUM_Payslip],[DA_FURA_E],[I_FURA_E]
' 
...
SET @query= N'
	...
	(
	select		' +@Top+ N'
				hp.ID AS ID,hp.ID AS ProfileID, hp.ProfileName + ''_'' + hp.CodeEmp as CodeEmp, hp.CodeEmp as E_CodeEmp , hp.ProfileName
