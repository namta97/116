...
set @query = N'						
		...
		select 
					...
					, ISNULL(neorg.DivisionName,0) AS DivisionName ,ISNULL(neorg.CenterName,0) AS CenterName, ISNULL(neorg.DepartmentName,0) AS DepartmentName ,ISNULL(neorg.SectionName,0) AS SectionName,ISNULL(neorg.UnitName,0) AS UnitName
