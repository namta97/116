...
@condition nvarchar(max) =  " and (MonthYear = '2021-09-01') and (CheckData like N'%E_UNEXPECTED%') ",
@PageIndex int = 1,
@PageSize int = 5000,
...
set @query3 = N'
	...
	left join Sal_UnusualPayItem usi43 on sup.UnusualPayID = usi43.UnusualPayID and usi43.code = ''ATTI_COUNT_WORKPAIDHOUR_DAYKEEP_BYUNUSUALPAY''
