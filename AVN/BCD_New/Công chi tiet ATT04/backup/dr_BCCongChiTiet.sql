...
select ' + @Top
		...
		END AS BusinessDay
		--,CASE WHEN ISNULL(BUSINESSDETAIL.BusinessDay1,0) +  ISNULL(BUSINESSDETAIL.BusinessDay2,0) + ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ( ISNULL(LEAVEDETAIL.LeaveDays1,0) + ISNULL(LEAVEDETAIL.LeaveDays2,0) + ISNULL(LEAVEDETAIL.LeaveDays3,0) ) > 0
		--	THEN ISNULL(BUSINESSDETAIL.BusinessDay1,0) +  ISNULL(BUSINESSDETAIL.BusinessDay2,0) + ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ( ISNULL(LEAVEDETAIL.LeaveDays1,0) + ISNULL(LEAVEDETAIL.LeaveDays2,0) + ISNULL(LEAVEDETAIL.LeaveDays3,0) )
		--	WHEN ISNULL(BUSINESSDETAIL.BusinessDay1,0) +  ISNULL(BUSINESSDETAIL.BusinessDay2,0) + ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ( ISNULL(LEAVEDETAIL.LeaveDays1,0) + ISNULL(LEAVEDETAIL.LeaveDays2,0) + ISNULL(LEAVEDETAIL.LeaveDays3,0) ) = 0
		--	THEN CASE WHEN ISNULL(BUSINESSDETAIL.BusinessDay1,0) - ISNULL(LEAVEDETAIL.LeaveDays1,0) > 0 THEN  ISNULL(BUSINESSDETAIL.BusinessDay1,0) - ISNULL(LEAVEDETAIL.LeaveDays1,0) ELSE 0 END
		--		+ CASE WHEN ISNULL(BUSINESSDETAIL.BusinessDay2,0) - ISNULL(LEAVEDETAIL.LeaveDays2,0) > 0 THEN  ISNULL(BUSINESSDETAIL.BusinessDay2,0) - ISNULL(LEAVEDETAIL.LeaveDays2,0) ELSE 0 END
		--		+ CASE WHEN ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ISNULL(LEAVEDETAIL.LeaveDays3,0) > 0 THEN  ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ISNULL(LEAVEDETAIL.LeaveDays3,0) ELSE 0 END
		--END AS BusinessDay
		,CASE WHEN cs.ShiftCode is not null THEN 
		    CASE WHEN
				ISNULL(BUSINESSDETAIL.BusinessDay1,0) + ISNULL(BUSINESSDETAIL.BusinessDay2,0) + ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ( ISNULL(LEAVEDETAIL.LeaveDays1,0) + ISNULL(LEAVEDETAIL.LeaveDays2,0) + ISNULL(LEAVEDETAIL.LeaveDays3,0) ) >= 0
				THEN 
				1 - ( ISNULL(BUSINESSDETAIL.BusinessDay1,0) + ISNULL(BUSINESSDETAIL.BusinessDay2,0) + ISNULL(BUSINESSDETAIL.BusinessDay3,0)
				+ CASE WHEN  ISNULL(BUSINESSDETAIL.BusinessDay2,0) - ISNULL(LEAVEDETAIL.LeaveDays2,0) > 0 THEN ISNULL(BUSINESSDETAIL.BusinessDay2,0) - ISNULL(LEAVEDETAIL.LeaveDays2,0) ELSE 0 END
				+ CASE WHEN  ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ISNULL(LEAVEDETAIL.LeaveDays3,0) > 0 THEN ISNULL(BUSINESSDETAIL.BusinessDay3,0) - ISNULL(LEAVEDETAIL.LeaveDays3,0) ELSE 0 END
				)
				ELSE
				1 - ( ISNULL(LEAVEDETAIL.LeaveDays1,0) + ISNULL(LEAVEDETAIL.LeaveDays2,0) + ISNULL(LEAVEDETAIL.LeaveDays3,0) ) 
			END
		END AS WorkDays
		...
		ELSE
			--CASE WHEN cs.ShiftCode IS NOT NULL THEN
				CASE WHEN LEAVEDETAIL.LeaveCode1 is not null 
					...
					THEN concat( LEAVEDETAIL.LeaveDays2, LEAVEDETAIL.LeaveCode2, '' | '', 1 - LEAVEDETAIL.LeaveDays2 , COALESCE(BUSINESSDETAIL.BusinessCode1,BUSINESSDETAIL.BusinessCode3,cs.ShiftCode ))

					when LEAVEDETAIL.LeaveCode2 is NULL AND LEAVEDETAIL.LeaveCode3 is not null
					then concat(1 - LEAVEDETAIL.LeaveDays3 , COALESCE(BUSINESSDETAIL.BusinessCode1,BUSINESSDETAIL.BusinessCode2,cs.ShiftCode ),  '' | '',LEAVEDETAIL.LeaveDays3, LEAVEDETAIL.LeaveCode3 )
					...
					THEN concat( BUSINESSDETAIL.BusinessDay2, BUSINESSDETAIL.BusinessCode2, '' | '', 1 - BUSINESSDETAIL.BusinessDay2 , COALESCE(BUSINESSDETAIL.BusinessCode3,cs.ShiftCode ))

					WHEN BUSINESSDETAIL.BusinessCode2 IS NULL AND BUSINESSDETAIL.BusinessCode3 IS NOT NULL
					THEN concat(1 - BUSINESSDETAIL.BusinessDay3 , COALESCE(BUSINESSDETAIL.BusinessCode2,cs.ShiftCode ),  '' | '', BUSINESSDETAIL.BusinessDay3, BUSINESSDETAIL.BusinessCode3 )
					ELSE cs.ShiftCode
				END
			--END
		END AS Symbol
...
from    Att_Workday as aw
        ...
        cross apply (select case when cdo.DateOff is not null AND ( ld1.LeaveDayTypeCode IS NULL OR ( ld1.LeaveDayTypeCode NOT LIKE ''SIB%'' AND  ld1.LeaveDayTypeCode <> ''LS'' ) ) then ''E_FULLSHIFT-1.0-H'' end as DayOff
						,case when ld1.DurationType = ''E_FULLSHIFT'' OR ld1.DurationType = ''E_FIRST'' OR ld1.DurationType = ''E_FIRST_AND_LAST'' OR ld1.DurationType = ''E_LAST''
								THEN
								CASE WHEN	 
                          ...
                          , case when ld1.DurationType = ''E_FIRSTHALFSHIFT'' OR ld1.DurationType = ''E_FIRST'' OR ld1.DurationType = ''E_FIRST_AND_LAST''
								THEN
                          ...
                          , case when ld1.DurationType = ''E_LASTHALFSHIFT'' OR ld1.DurationType = ''E_LAST'' OR ld1.DurationType = ''E_FIRST_AND_LAST''
								THEN
		...
		cross apply ( SELECT
						case when tbt1.DurationType = ''E_FULLSHIFT'' OR  tbt1.DurationType = ''E_FIRST'' OR  tbt1.DurationType = ''E_FIRST_AND_LAST'' OR  tbt1.DurationType = ''E_LAST''
								THEN
								CASE WHEN
                          ...
                          , case when tbt1.DurationType = ''E_FIRSTHALFSHIFT'' OR tbt1.DurationType = ''E_FIRST'' OR tbt1.DurationType = ''E_FIRST_AND_LAST'' 
								THEN
								CASE WHEN	
                          ...
                          , case when tbt1.DurationType = ''E_LASTHALFSHIFT'' OR tbt1.DurationType = ''E_LAST'' OR tbt1.DurationType = ''E_FIRST_AND_LAST'' 
								THEN
								CASE WHEN	
