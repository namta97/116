...
set @query = '
	...
	select		' +@Top+ N'
				spt.ProfileID AS ID ,spt.ProfileID, hp.CodeEmp,hp.ProfileName, hp.NameEnglish
...
set @query1 = '
	...
	FROM 
				...
				(
					...
					,''AVN_ThuePIT'',''AVN_TCTV_Tax'',''AVN_TongPIT'',''AVN_AdvancePay'',''AVN_NetIncome'',''ThuNhapKhongChiuThue'',''AVN_OT_NonTax'',''AVN_Thuong_NonTax''
...
'set @query2 = '
	...
	LEFT JOIN	sal_payrolltableitem pri8 on rs.PayrollTableID=pri8.payrolltableid and pri8.code = ''AVN_Deduction_SUM_DETAIL''
